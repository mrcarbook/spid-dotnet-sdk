...
namespace TCPWare.Spid.ChatBot.Dialogs
{
    ...
    {
        public const string UrlSpid = "http://localhost:62371";
            ...
            try
            {
                ...
                switch (optionSelected)
                {
                    ...
                    case OptionLogin:
                            ...
                            Buttons = new List<CardAction>()
                        {
                                     new CardAction()
                            {
                                ...
                                Value = $"{UrlSpid}/Home/SpidRequest?idpLabel=poste_id"
                            },
                            new CardAction()
                            {
                                Title = "InfoCert",
                                Type = ActionTypes.OpenUrl,
                                  Value = $"{UrlSpid}/Home/SpidRequest?idpLabel=infocert_id"
                            },
                             new CardAction()
                            {
                                Title = "Aruba",
                                Type = ActionTypes.OpenUrl,
                                 Value = $"{UrlSpid}/Home/SpidRequest?idpLabel=aruba_id"
                            }
                             ,
                             new CardAction()
                            {
                    ...
                    case "VerificaLogin":
                        ...
                        var spid = context.UserData.GetValueOrDefault<string>("SPID");
                        await context.PostAsync("Ecco i tuoi dati " + spid);
